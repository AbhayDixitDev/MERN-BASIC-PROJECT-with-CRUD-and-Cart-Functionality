...
const Kidswear = () => {
    ...
    const loadData = async () => {
        try {
            ...
            // Filter data to only include kids products
            const mensData = (response.data).filter(item => item.category === 'kids');
            setMydata(mensData);
        } catch (error) {
    ...
    return (
        <>
            <h1 style={{ textAlign: 'left', backgroundColor: "#1a1a1a", color: "#f0f0f0",padding: "20px" }}>Kids Wears</h1>
